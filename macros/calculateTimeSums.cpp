...
HistogramTimeSums calculateTimeSums(DataSet* data, imagingDetectors userDet) {
	...
	timesums.layer_upos = new TH1D("upos", "TimeSum upos layer", 800, 50, 200);
	timesums.layer_vpos = new TH1D("vpos", "TimeSum vpos layer", 800, 50, 200);
	timesums.layer_wpos = new TH1D("wpos", "TimeSum wpos layer", 800, 50, 200);
	timesums.layer_uneg = new TH1D("uneg", "TimeSum uneg layer", 800, 40, 180);
	timesums.layer_vneg = new TH1D("vneg", "TimeSum vneg layer", 800, 60, 160);
	timesums.layer_wneg = new TH1D("wneg", "TimeSum wneg layer", 800, 60, 160);
