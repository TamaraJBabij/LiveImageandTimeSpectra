...
#define CFG_CHANNEL_ELEC_U1_S 29//21//27
#define CFG_CHANNEL_ELEC_U2_S 30//18//28
#define CFG_CHANNEL_ELEC_V1_S 27//19//25
#define CFG_CHANNEL_ELEC_V2_S 28//20//26
#define CFG_CHANNEL_ELEC_W1_S 25//17//29
#define CFG_CHANNEL_ELEC_W2_S 26//22//30
...
#define CFG_DELAY_ELEC_CP2 10//56.2
#define CFG_DELAY_ELEC_U1_S 10//57.6
#define CFG_DELAY_ELEC_U2_S 10//57.6
#define CFG_DELAY_ELEC_V1_S 10//57.6
#define CFG_DELAY_ELEC_V2_S 10//57.6
#define CFG_DELAY_ELEC_W1_S 10//57.6
#define CFG_DELAY_ELEC_W2_S 10//57.6
